...
import static com.coursehub.media_stock_service.util.MediaValidator.*;

@Service
public class VideoStorageService {
    private final Path baseLocation;

    public VideoStorageService(@Value("${base.storage.location}") Path baseLocation) {
    ...
    protected String storeVideo(MultipartFile file, String subFolder) {
        ...
        String extension = getValidVideoExtension(file);
