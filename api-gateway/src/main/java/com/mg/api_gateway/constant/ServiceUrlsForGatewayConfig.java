...
public final class ServiceUrlsForGatewayConfig {
    ...
    public static final String PAYMENT_ID = "payment";
    ...
    public static final String PAYMENT_PATH = "/v1/payment/**";
    ...
    public static final String PAYMENT_LB_URI = "lb://payment-service";
